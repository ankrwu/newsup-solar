"""
光伏们 (www.solarzoom.com) 爬虫
光伏行业专业媒体，技术深度报道，市场分析
...
class SolarZoomCrawler(BaseCrawler, DynamicContentCrawler):
    """光伏们爬虫 - 光伏行业专业媒体"""
    ...
    def source_url(self) -> str:
        return "https://www.solarzoom.com"
    ...
    async def fetch_article_urls(self) -> List[str]:
        ...
        logger.info(f"从光伏们总共找到 {len(article_urls)} 篇文章")
    ...
    async def _fetch_with_playwright(self) -> List[str]:
        ...
        category_urls = [
            ...
            f"{self.source_url}/article/",
            f"{self.source_url}/market/",
            f"{self.source_url}/technology/",
        ]
    ...
    def _extract_title(self, soup: BeautifulSoup) -> str:
        ...
        for selector in selectors:
            ...
            if elem:
                ...
                title = re.sub(r'[-_]\s*光伏们.*$', '', title)
                title = re.sub(r'[-_]\s*solarzoom.*$', '', title, flags=re.IGNORECASE)
                return title
